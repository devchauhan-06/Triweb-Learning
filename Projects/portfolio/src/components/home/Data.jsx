...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Dev Chauhan
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">"I am a developer based in Dehradun , Uttrakhand with a passion for crafting dynamic web applications.</p>
